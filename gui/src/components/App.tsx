...
import {A, Navigate, Route, Routes, useNavigate, useSearchParams} from "@solidjs/router";
...
const Home: Component = () => {
	...
	if (searchParams.token_hash && searchParams.email) {
		...
		(async () => {
			...
			setSearchParams({...searchParams, token_hash: undefined, email: undefined, type: undefined});
